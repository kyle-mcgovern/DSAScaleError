...
g <- g + annotate("text", x=(mean(df$x)-0.6)/2, y=height+0.25+0.125, label=TeX("$\\vartheta_1=\\theta_1-mean(\\theta_1$,...,$\\theta_D)$"), hjust=0.5, size=3.5, color="#D81B60")
...
g <- g + annotate("text", x=(-0.6)/2, y=height-0.35-0.125, label=TeX("$\\theta_1$"), hjust=0.5, size=3.5, color="#1E88E5")
...
g <- g + annotate("text", x=0, y=1.37, label=0, size=3.5, color=line_color) + annotate("text", x=0, y=offset_bot+0.37, label=0, size=3.5, color=line_color) # Top +
